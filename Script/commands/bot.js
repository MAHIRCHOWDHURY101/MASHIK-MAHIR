...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "mahir") || (event.body.toLowerCase() == "Mahir vai") || (event.body.toLowerCase() == "@MAHIR ") || (event.body.toLowerCase() == "মাহির")) {
     return api.sendMessage("মাহির বস এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ MAHIR ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/THE.FATHER.OFF.GALIBAZ.MAHIR.5\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0197993****", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:MAHIR ❤️ হাই আমি MESSENGER ROBOT  আামার বস MAHIR আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is MAHIR ッ❤️ তাকে সবাই মাহির নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "@𝐀𝐑𝐎𝐇𝐈 ________// ;* :/ 3:)") || (event.body.toLowerCase() == "@𝐀𝐑𝐎𝐇𝐈 ________// ;* :/ 3:) ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস মাহির এর বউ এর আইডি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Arohi") || (event.body.toLowerCase() == "Eva")) {
  ...
  if ((event.body.toLowerCase() == "@ᎷᎪᏚᎻᏆᏦ ᎷᎪᎻᏆᎡ─꯭─꯭─꯭─꯭─꯭╱╱😘😕😈 ") || (event.body.toLowerCase() == "মাহির")) {
